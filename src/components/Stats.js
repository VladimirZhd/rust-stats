		...
		<>
			<div className='statistics'>
				...
				<div className='stats'>
					...
					<div className='kds'>
						<h3>K/D {Math.round((total_kills / stats.deaths) * 100) / 100}</h3>
						<p>
							K/D vs Bear:{' '}
							{Math.round((stats.kill_bear / stats.death_bear) * 100) / 100}
						</p>
						<p>
							K/D vs Wolf:{' '}
							{Math.round((stats.kill_wolf / stats.death_wolf) * 100) / 100}
						</p>
						<p>
							K/D vs Players:{' '}
